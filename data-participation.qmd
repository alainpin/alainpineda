...
Participation differs by sex within every age group, though age spreads it
more widely than sex does. The gap is shown here as (men − women) / men, so
it has no units and the age groups can share one chart. The line in ink is
the national gap without the age split.
