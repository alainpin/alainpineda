...
All series here are **original**, without seasonal adjustment. The faint line
behind each one is INEGI's own **trend-cycle** series, shown as reading
context. That line is revised backward as new quarters arrive, so the figure
quoted on each card always comes from the original series. Two indicators,
broader unemployment and labor underutilization, have no quarterly trend-cycle
series published by INEGI and appear without one.
