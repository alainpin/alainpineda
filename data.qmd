...
Interactive figures from my work. Everything runs in your browser; series are
prepared in R and published as CSV in `data/` in the
...
Three headline rates from Mexico's labor force survey (ENOE), recomputed from
microdata using the survey's complex design (strata and expansion factors, not
a simple mean) and checked against INEGI's official bulletin for 2024-T1
(largest gap: 0.05 percentage points).
