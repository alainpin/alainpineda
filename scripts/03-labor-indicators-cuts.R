...
# data-informalidad.qmd (y sus versiones es/) -- los cortes por sexo, edad,
# nivel educativo y entidad que la propia INEGI no publica en su sitio.
#
...
# calculados (TPEA, TIL1, TIL2, TOSI1, TOSI2). Es pura recombinacion de
# categorias que la ENOE ya distingue por separado (sexo, grupo de edad,
# nivel de instruccion, entidad) -- nada institucionalmente sensible, mismo
# criterio que ya aplica 02-labor-indicators.R.
#
...
indicadores_con_cortes <- c("TPEA", "TIL1", "TIL2", "TOSI1", "TOSI2")
