...
explainer: ../files/social-insurance-without-a-job-slides-es.html
---
...
Tasa de informalidad previa a la política, por estado; promedio 2013–2015.
Cálculo propio con microdatos de la ENOE (INEGI).
:::
...
Existe un [explicador](../../../../files/social-insurance-without-a-job-slides-es.html)
de este documento que recorre el mismo resultado para un público general, con
una explicación en lenguaje accesible del análisis de sensibilidad de
Rambachan y Roth (2023), que mide cuánto tendría que fallar el supuesto de
identificación antes de que el resultado desaparezca.
...
- [Replicación](https://zenodo.org/records/22168219)
