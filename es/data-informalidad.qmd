...
cuatro definiciones de informalidad, cada una desglosada por sexo, grupo de
edad, nivel educativo y entidad. Ningún corte usa una definición propia:
...
definiciones = ({
  ...
  TOSI2: {
    ...
    texto: "El mismo conteo de ocupación en el sector informal, pero como proporción de la población ocupada no agropecuaria en vez de la ocupada total. El sector informal ya es no agropecuario, así que esta tasa queda por encima de la anterior."
  }
})
...
validadas contra las series originales que INEGI publica en su Banco de
Información Económica (BIE) antes de llegar a esta página. La banda sombreada y las líneas de error son un intervalo de 95% de
