...
subtitle: "Nota · ENBIARE 2025"
description: "Entre entidades, las viviendas con más activos tienen menos mascotas. Dentro del país, tienen más. Los mismos datos en dos niveles de agregación dan signos opuestos, que es la forma que toma la falacia ecológica en la práctica."
date: 2026-09-02
...
::: {.eyebrow}
Nota · INEGI, ENBIARE 2025 · Microdatos públicos
:::
...
La cifra circuló, y con ella un orden de las entidades. Ese orden es donde
...
Esto es la **falacia ecológica**: una relación medida entre grupos no tiene
por qué sostenerse, ni siquiera conservar el signo, para los individuos que
están dentro de esos grupos. La correlación estatal es un hecho sobre
entidades. Leerla como un hecho sobre hogares es el error, y nada en los datos
agregados avisa que está ocurriendo.
