...
// Sort state for the Changes by group table's clickable column headers --
// clicking a header sorts by that column, sets a fresh column to
// descending, and toggles a re-click between descending and ascending.
// Defaults to the old fixed order's spirit (biggest quarterly increase
// first) but as a real signed sort, since that's what a clickable header's
// arrow can actually represent.
...
<thead><tr>
  <th>Indicator</th><th>Latest</th><th>Quarterly change (t vs t-1)</th><th>Annual change (t vs t-4)</th>
</tr></thead>
<tbody>
...
Click a column header below to sort by it; click again to reverse.
...
<thead><tr>
  ...
  ${celdaEncabezado("Latest", "valor")}
  ${celdaEncabezado("Quarterly change (t vs t-1)", "deltaTrim")}
  ${celdaEncabezado("Annual change (t vs t-4)", "deltaAnual")}
</tr></thead>
<tbody>
