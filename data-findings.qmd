...
The men-minus-women gap for the indicators where INEGI's own headline
numbers hide it. Not exhaustive — more indicators may be added here over
time.
...
<li>${textoBrecha("Unemployment", brechaTD)}</li>
</ul>`
```
